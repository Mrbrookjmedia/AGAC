...
>>>>>>> dc1aae3bfa20cbadbe19f9b7193c17e0ddab61b4
        </div>
      </div>
    </div>
  </div>
  ...
  <div className="mt-3 font-medium text-customBlackText leading-7 text-lg mb-10 w-full md:w-3/4">
    Explore how AGAC leverages advanced analytics to extract meaningful insights from collected data, enhancing decision-making and research outcomes.
  </div>
  ...
  <div className="flex flex-col md:flex-row flex-wrap gap-8 justify-center">
    <div className="flex flex-col items-center md:items-start p-4 bg-white rounded shadow-md w-full md:w-80">
      <img src={research19} alt="Research" className="w-full max-w-xs mb-4" />
    ...
    <div className="flex flex-col items-center md:items-start p-4 bg-white rounded shadow-md w-full md:w-80">
      <img src={research20} alt="Research" className="w-full max-w-xs mb-4" />
      <span className="bg-green-500 text-white font-medium my-2 p-2 rounded w-full text-center">
        Big data Integration
      </span>
      <div className="mt-2 text-customBlackText leading-5 text-sm text-center md:text-left">
    ...
    <div className="flex flex-col items-center md:items-start p-4 bg-white rounded shadow-md w-full md:w-80">
      <img src={research21} alt="Research" className="w-full max-w-xs mb-4" />
      <span className="bg-green-500 text-white font-medium my-2 p-2 rounded w-full text-center">
        Data Visualization
      </span>
      <div className="mt-2 text-customBlackText leading-5 text-sm text-center md:text-left">
